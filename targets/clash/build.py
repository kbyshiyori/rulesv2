#!/usr/bin/env python3
"""Build minimal mihomo profiles for Clash/Hako or Clash Verge Rev."""
...
def render(
    profile: str, domains: list[str], direct_rules: list[str], dns: str,
    platform: str = "hako",
) -> str:
    if platform not in {"hako", "verge"}:
...
def main() -> int:
    ...
    parser.add_argument("--platform", choices=["hako", "verge"], default="hako")
    ...
    text = render(args.profile, domains, direct_rules, args.dns, args.platform)
    out = Path(args.out)
